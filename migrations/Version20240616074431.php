 ...
 */
final class Version20240616074431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artwork (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, artwork_name VARCHAR(255) NOT NULL, artwork_description VARCHAR(255) DEFAULT NULL, artwork_image VARCHAR(255) NOT NULL, INDEX IDX_881FC576A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
