...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private $isPasswordResetRequired = false;
    ...
    public function setPasswordResetRequired(bool $isPasswordResetRequired): self
    {
        ...
        /**
     * @ORM\OneToMany(targetEntity="App\Entity\Artwork", mappedBy="user", orphanRemoval=true)
     */
    private $artworks;
